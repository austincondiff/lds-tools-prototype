...
class Slide extends React.Component {
  ...
  setElHeight = el =>
    this.setState({ elDimensions: el.getBoundingClientRect() }, () => (this.elHeight = el.getBoundingClientRect().height))
    ...
    return (
      ...
      >
        {(state, childProps) => {
          ...
          return React.cloneElement(children, { style: { ...style, ...styles[state] }, ...childProps })
        }}
      </Transition>
    )
  }
