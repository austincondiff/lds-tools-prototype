...
class TabContainer extends Component {
  ...
  componentDidMount() {
    ...
    if (useRouter && location.query && location.query.tab && tabs.filter(tab => tab.value === location.query.tab).length) {
  ...
  componentDidUpdate() {
    ...
    if (useRouter && location.query && location.query.tab && location.query.tab !== value) this.handleTabChange(value)
  }
