...
class Modal extends React.Component {
  ...
  handleBackdropClick = event => {
    ...
    if (!this.props.disableBackdropClick && this.props.onClose) this.props.onClose(event, 'backdropClick')
  }
  ...
  handleDocumentKeyDown = event => {
    ...
    if (!this.props.disableEscapeKeyDown && this.props.onClose) this.props.onClose(event, 'escapeKeyDown')
  }

  enforceFocus = () => {
    if (!this.isTopModal() || this.props.disableEnforceFocus || !this.mounted || !this.dialogRef) return
  ...
  render() {
    ...
    if (hasTransition) childProps.onExited = createChainedFunction(this.handleExited, children.props.onExited)
    ...
    return (
      <Portal ref={this.handlePortalRef} container={container} disablePortal={disablePortal} onRendered={this.handleRendered}>
        <ModalWrap ref={this.handleModalRef} position={position} zIndex={zIndex}>
